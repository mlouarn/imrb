...
###GSE217847
GSM6727558 <- ReadMtx(  mtx = "GSE217847_RAW/GSM6727558_Tumor_DAY_10_matrix.mtx.gz", features = "GSE217847_RAW/GSM6727558_Tumor_DAY_10_features.tsv.gz",
                        cells = "GSE217847_RAW/GSM6727558_Tumor_DAY_10_barcodes.tsv.gz")
GSM6727558 <- CreateSeuratObject(counts = GSM6727558, project = "GSM6727558", min.cells = 3)
GSM6727558 <- seurat_analyse(GSM6727558)
saveRDS(GSM6727558, file = "GSE217847_RAW/GSM6727558.rds")

GSM6727559 <- ReadMtx(  mtx = "GSE217847_RAW/GSM6727559_Tumor_DAY_20_matrix.mtx.gz", features = "GSE217847_RAW/GSM6727559_Tumor_DAY_20_features.tsv.gz",
                        cells = "GSE217847_RAW/GSM6727559_Tumor_DAY_20_barcodes.tsv.gz")
GSM6727559 <- CreateSeuratObject(counts = GSM6727559, project = "GSM6727559", min.cells = 3)
GSM6727559 <- seurat_analyse(GSM6727559)
saveRDS(GSM6727559, file = "GSE217847_RAW/GSM6727559.rds")

GSM6727560 <- ReadMtx(  mtx = "GSE217847_RAW/GSM6727560_Tumor_DAY_30_matrix.mtx.gz", features = "GSE217847_RAW/GSM6727560_Tumor_DAY_30_features.tsv.gz",
                        cells = "GSE217847_RAW/GSM6727560_Tumor_DAY_30_barcodes.tsv.gz")
GSM6727560 <- CreateSeuratObject(counts = GSM6727560, project = "GSM6727560", min.cells = 3)
GSM6727560 <- seurat_analyse(GSM6727560)
saveRDS(GSM6727560, file = "GSE217847_RAW/GSM6727560.rds")

GSM6727561 <- ReadMtx(  mtx = "GSE217847_RAW/GSM6727561_Healthy_Pancreas_matrix.mtx.gz", features = "GSE217847_RAW/GSM6727561_Healthy_Pancreas_features.tsv.gz",
                        cells = "GSE217847_RAW/GSM6727561_Healthy_Pancreas_barcodes.tsv.gz")
GSM6727561 <- CreateSeuratObject(counts = GSM6727561, project = "GSM6727561", min.cells = 3)
GSM6727561 <- seurat_analyse(GSM6727561)
saveRDS(GSM6727561, file = "GSE217847_RAW/GSM6727561.rds")

GSM6727566 <- ReadMtx(  mtx = "GSE217847_RAW/GSM6727566_Tumor_DAY_7_WT_matrix.mtx.gz", features = "GSE217847_RAW/GSM6727566_Tumor_DAY_7_WT_features.tsv.gz",
                        cells = "GSE217847_RAW/GSM6727566_Tumor_DAY_7_WT_barcodes.tsv.gz")
GSM6727566 <- CreateSeuratObject(counts = GSM6727566, project = "GSM6727566", min.cells = 3)
GSM6727566 <- seurat_analyse(GSM6727566)
saveRDS(GSM6727566, file = "GSE217847_RAW/GSM6727566.rds")

GSM6727567 <- ReadMtx(  mtx = "GSE217847_RAW/GSM6727567_Tumor_DAY_7_COX2_KO_matrix.mtx.gz", features = "GSE217847_RAW/GSM6727567_Tumor_DAY_7_COX2_KO_features.tsv.gz",
                        cells = "GSE217847_RAW/GSM6727567_Tumor_DAY_7_COX2_KO_barcodes.tsv.gz")
GSM6727567 <- CreateSeuratObject(counts = GSM6727567, project = "GSM6727567", min.cells = 3)
GSM6727567 <- seurat_analyse(GSM6727567)
saveRDS(GSM6727567, file = "GSE217847_RAW/GSM6727567.rds")

GSM6727568 <- ReadMtx(  mtx = "GSE217847_RAW/GSM6727568_KPC_GEMM_Sample1_matrix.mtx.gz", features = "GSE217847_RAW/GSM6727568_KPC_GEMM_Sample1_features.tsv.gz",
                        cells = "GSE217847_RAW/GSM6727568_KPC_GEMM_Sample1_barcodes.tsv.gz")
GSM6727568 <- CreateSeuratObject(counts = GSM6727568, project = "GSM6727568", min.cells = 3)
GSM6727568 <- seurat_analyse(GSM6727568)
saveRDS(GSM6727568, file = "GSE217847_RAW/GSM6727568.rds")

GSM6727569 <- ReadMtx(  mtx = "GSE217847_RAW/GSM6727569_KPC_GEMM_Sample2_matrix.mtx.gz", features = "GSE217847_RAW/GSM6727569_KPC_GEMM_Sample2_features.tsv.gz",
                        cells = "GSE217847_RAW/GSM6727569_KPC_GEMM_Sample2_barcodes.tsv.gz")
GSM6727569 <- CreateSeuratObject(counts = GSM6727569, project = "GSM6727569", min.cells = 3)
GSM6727569 <- seurat_analyse(GSM6727569)
saveRDS(GSM6727569, file = "GSE217847_RAW/GSM6727569.rds")

GSM6727570 <- ReadMtx(  mtx = "GSE217847_RAW/GSM6727570_KC_Ortho_Sample1_matrix.mtx.gz", features = "GSE217847_RAW/GSM6727570_KC_Ortho_Sample1_genes.tsv.gz",
                        cells = "GSE217847_RAW/GSM6727570_KC_Ortho_Sample1_barcodes.tsv.gz")
GSM6727570 <- CreateSeuratObject(counts = GSM6727570, project = "GSM6727570", min.cells = 3)
GSM6727570 <- seurat_analyse(GSM6727570)
saveRDS(GSM6727570, file = "GSE217847_RAW/GSM6727570.rds")

GSM6727571 <- ReadMtx(  mtx = "GSE217847_RAW/GSM6727571_KC_Ortho_Sample2_matrix.mtx.gz", features = "GSE217847_RAW/GSM6727571_KC_Ortho_Sample2_genes.tsv.gz",
                        cells = "GSE217847_RAW/GSM6727571_KC_Ortho_Sample2_barcodes.tsv.gz")
GSM6727571 <- CreateSeuratObject(counts = GSM6727571, project = "GSM6727571", min.cells = 3)
GSM6727571 <- seurat_analyse(GSM6727571)
saveRDS(GSM6727571, file = "GSE217847_RAW/GSM6727571.rds")

GSM6727572 <- ReadMtx(  mtx = "GSE217847_RAW/GSM6727572_KC_Hetero_Sample1_matrix.mtx.gz", features = "GSE217847_RAW/GSM6727572_KC_Hetero_Sample1_genes.tsv.gz",
                        cells = "GSE217847_RAW/GSM6727572_KC_Hetero_Sample1_barcodes.tsv.gz")
GSM6727572 <- CreateSeuratObject(counts = GSM6727572, project = "GSM6727572", min.cells = 3)
GSM6727572 <- seurat_analyse(GSM6727572)
saveRDS(GSM6727572, file = "GSE217847_RAW/GSM6727572.rds")

GSM6727573 <- ReadMtx(  mtx = "GSE217847_RAW/GSM6727573_KC_Hetero_Sample2_matrix.mtx.gz", features = "GSE217847_RAW/GSM6727573_KC_Hetero_Sample2_genes.tsv.gz",
                        cells = "GSE217847_RAW/GSM6727573_KC_Hetero_Sample2_barcodes.tsv.gz")
GSM6727573 <- CreateSeuratObject(counts = GSM6727573, project = "GSM6727573", min.cells = 3)
GSM6727573 <- seurat_analyse(GSM6727573)
saveRDS(GSM6727573, file = "GSE217847_RAW/GSM6727573.rds")
...
for (i in c("GSM9217269_SS_20_0088","GSM9217270_SS_20_0089","GSM9217271_SS_20_0090","GSM9217272_SS_20_0335","GSM9217273_SS_20_0336","GSM9217274_SS_20_0337","GSM9217275_SS_20_0368","GSM9217276_SS_20_0369","GSM9217277_SS_20_0370","GSM9217278_SS_20_0449","GSM9217279_SS_20_0450","GSM9217280_SS_20_0451","GSM9217281_SS_20_0524","GSM9217282_SS_20_0525","GSM9217283_SS_20_0526","GSM9217284_SS_20_0527","GSM9217285_SS_20_0528","GSM9217286_SS_20_0529","GSM9217287_SS_20_0530","GSM9217288_SS_20_0531","GSM9217289_SS_20_0532","GSM9217290_SS_20_0578","GSM9217291_SS_20_0579","GSM9217292_SS_20_0580","GSM9217293_SS_20_0621","GSM9217294_SS_20_0622","GSM9217295_SS_20_0623","GSM9217296_SS_20_0744","GSM9217297_SS_20_0745","GSM9217298_SS_20_0746")){
  obj <- ReadMtx(  mtx = paste0("GSE307143_RAW/",i,"_matrix.mtx.gz"), features = paste0("GSE307143_RAW/",i,"_features.tsv.gz"),
                            cells = paste0("GSE307143_RAW/",i,"_barcodes.tsv.gz"))
  name = substr(i, 1, nchar(i)-11)
  obj <- CreateSeuratObject(counts = obj, project = name, min.cells = 3)
  obj <- seurat_analyse(obj)
  saveRDS(obj, file = paste0("GSE307143_RAW/",name,".rds"))
}
rm(name,i)
...
for (i in c("GSM8830804_T1","GSM8830805_T2","GSM8830806_T3","GSM8830807_T4","GSM8830808_T5","GSM8830809_T6","GSM8830810_T7","GSM8830811_T8","GSM8830812_T9","GSM8830813_T10")){
  obj <- ReadMtx(  mtx = paste0("GSE291211_RAW/",i,"_matrix.mtx.gz"), features = paste0("GSE291211_RAW/",i,"_features.tsv.gz"),
                   cells = paste0("GSE291211_RAW/",i,"_barcodes.tsv.gz"))
  name = substr(i, 1, nchar(i)-3)
  obj <- CreateSeuratObject(counts = obj, project = name, min.cells = 3)
  obj <- seurat_analyse(obj)
  saveRDS(obj, file = paste0("GSE291211_RAW/",name,".rds"))
}
rm(name,i)
gc()
...
for (i in c('GSM9001991_PyMT_Lung_NC_rep1','GSM9001992_PyMT_Lung_NC_rep2','GSM9001993_PyMT_Lung_CS_rep1','GSM9001994_PyMT_Lung_CS_rep2')){
  obj <- Read10X_h5(paste0("GSE297920_RAW/",i,".h5"), use.names = TRUE, unique.features = TRUE)
  name = substr(i, 1, nchar(i)-18)
  obj <- CreateSeuratObject(counts = obj, project = name, min.cells = 3)
  obj <- seurat_analyse(obj)
  saveRDS(obj, file = paste0("GSE297920_RAW/",name,".rds"))
}
rm(name,i)
gc()
...
for (i in c('GSM8993905_PyMT_Tumor_NC_rep1','GSM8993906_PyMT_Tumor_NC_rep2','GSM8993907_PyMT_Tumor_MS_rep1','GSM8993908_PyMT_Tumor_MS_rep2')){
  obj <- Read10X_h5(paste0("GSE297521_RAW/",i,"_filtered_feature_bc_matrix.h5"), use.names = TRUE, unique.features = TRUE)
  name = substr(i, 1, 10)
  obj <- CreateSeuratObject(counts = obj, project = name, min.cells = 3)
  obj <- seurat_analyse(obj)
  saveRDS(obj, file = paste0("GSE297521_RAW/",name,".rds"))
}
rm(name,i)
gc()
...
for (i in c('GSM8487918_PYMT_CXCR4_cKO_TUMOR','GSM8487919_PYMT_CXCR4_CTRL_TUMOR','GSM8767523_Normal_MG')){
  obj <- Read10X_h5(paste0("GSE275907_RAW/",i,"_filtered_feature_bc_matrix.h5"), use.names = TRUE, unique.features = TRUE)
  name = substr(i, 1, 10)
  obj <- CreateSeuratObject(counts = obj, project = name, min.cells = 3)
  obj <- seurat_analyse(obj)
  saveRDS(obj, file = paste0("GSE275907_RAW/",name,".rds"))
}
rm(name,i)
gc()
...
for (i in c('GSM7821160_1','GSM7821161_8','GSM7821162_17','GSM7821163_21')){
  obj <- ReadMtx(  mtx = paste0("GSE244582_RAW/",i,"_matrix.mtx.gz"), features = paste0("GSE244582_RAW/",i,"_features.tsv.gz"),
                   cells = paste0("GSE244582_RAW/",i,"_barcodes.tsv.gz"))
  name = substr(i, 1, 10)
  obj <- CreateSeuratObject(counts = obj, project = name, min.cells = 3)
  obj <- seurat_analyse(obj)
  saveRDS(obj, file = paste0("GSE244582_RAW/",name,".rds"))
}
rm(name,i)
gc()
...
for (i in c('GSM8654897_s1.','GSM8654898_s2.','GSM8654899_s3.','GSM8654900_s4.','GSM8654901_s5.','GSM8654902_s6_')){
  df <- as.data.frame(t(fread(paste0('GSE283034_RAW/',i,'counts.csv.gz'))))
  colnames(df) <- as.character(df[1, ])
  df <- df[-1,]
  name = substr(i, 1, 10)  
  obj <- CreateSeuratObject(counts = df, project = name, min.cells = 3)
  obj <- seurat_analyse(obj)
  saveRDS(obj, file = paste0("GSE283034_RAW/",name,".rds"))
}
...
for (i in c("GSM7177495_PyMT_24h_BD_4186",  "GSM7177491_PyMT_Fresh_10x_rep1_2075",  "GSM7177492_PyMT_Fresh_10x_rep2_1925",  "GSM7177494_PyMT_Fresh_BD_3772")){
  obj <- ReadMtx(  mtx = paste0("GSE229765_RAW/",i,"cells_matrix.mtx.gz"), features = paste0("GSE229765_RAW/",i,"cells_genes.tsv.gz"),
                   cells = paste0("GSE229765_RAW/",i,"cells_barcodes.tsv.gz"),feature.column = 1)
  name = substr(i, 1, 10)
  obj <- CreateSeuratObject(counts = obj, project = name, min.cells = 3)
  obj <- seurat_analyse(obj)
  saveRDS(obj, file = paste0("GSE229765_RAW/",name,".rds"))
}
rm(name,i,obj)
gc()
...
for (i in c('GSM7993444_KO1','GSM7993445_KO2','GSM7993446_KO3','GSM7993447_WT1','GSM7993448_WT2')){
  obj <- ReadMtx(  mtx = paste0("GSE252083_RAW/",i,"_matrix.mtx.gz"), features = paste0("GSE252083_RAW/",i,"_genes.tsv.gz"),
                   cells = paste0("GSE252083_RAW/",i,"_barcodes.tsv.gz"))
  name = substr(i, 1, 10)
  obj <- CreateSeuratObject(counts = obj, project = name, min.cells = 3)
  obj <- seurat_analyse(obj)
  saveRDS(obj, file = paste0("GSE252083_RAW/",name,".rds"))
}
rm(name,i,obj)
gc()
...
for (i in c('GSM8212431_Sample1_Z46_filtered','GSM8212432_Sample2_Control_filtered')){
  obj <- ReadMtx(  mtx = paste0("GSE264124_RAW/",i,"_matrix.mtx.gz"), features = paste0("GSE264124_RAW/",i,"_features.tsv.gz"),
                   cells = paste0("GSE264124_RAW/",i,"_barcodes.tsv.gz"))
  name = substr(i, 1, 10)
  obj <- CreateSeuratObject(counts = obj, project = name, min.cells = 3)
  obj <- seurat_analyse(obj)
  saveRDS(obj, file = paste0("GSE264124_RAW/",name,".rds"))
}
rm(name,i,obj)
gc()
...
for (i in c('GSM4830541_T1','GSM4830542_T2','GSM4830543_T3','GSM4830544_T4')){
  obj <- ReadMtx(  mtx = paste0("GSE159478_RAW/",i,"_matrix.mtx.gz"), features = paste0("GSE159478_RAW/",i,"_genes.tsv.gz"),
                   cells = paste0("GSE159478_RAW/",i,"_barcodes.tsv.gz"))
  name = substr(i, 1, 10)
  obj <- CreateSeuratObject(counts = obj, project = name, min.cells = 3)
  obj <- seurat_analyse(obj)
  saveRDS(obj, file = paste0("GSE159478_RAW/",name,".rds"))
}
rm(name,i,obj)
gc()
...
for (i in c('GSM7159211_ABT_CD45_pos','GSM7159213_INK_CD45_pos','GSM7159215_Veh_CD45_pos','GSM7159217_WT_CD45_pos')){
  obj <- ReadMtx(  mtx = paste0("GSE229355_RAW/",i,"_matrix.mtx.gz"), features = paste0("GSE229355_RAW/",i,"_features.tsv.gz"),
                   cells = paste0("GSE229355_RAW/",i,"_barcodes.tsv.gz"))
  name = substr(i, 1, 10)
  obj <- CreateSeuratObject(counts = obj, project = name, min.cells = 3)
  obj <- seurat_analyse(obj)
  saveRDS(obj, file = paste0("GSE229355_RAW/",name,".rds"))
}
rm(name,i,obj)
gc()
...
for (i in c('GSM8208011_pymt_fresh_l1','GSM8208012_pymt_fresh_l2','GSM8208013_pymt_fresh_l3','GSM8208014_pymt_fresh_l4','GSM8208015_pymt_fresh_l5','GSM8208016_pymt_fresh_l6')){
  obj <- ReadMtx(  mtx = paste0("GSE263963_RAW/",i,"_matrix.mtx.gz"), features = paste0("GSE263963_RAW/",i,"_features.tsv.gz"),
                   cells = paste0("GSE263963_RAW/",i,"_barcodes.tsv.gz"))
  name = substr(i, 1, 10)
  obj <- CreateSeuratObject(counts = obj, project = name, min.cells = 3)
  obj <- seurat_analyse(obj)
  saveRDS(obj, file = paste0("GSE263963_RAW/",name,".rds"))
}
rm(name,i,obj)
gc()

###GSE222524 : Not touched
GSM6925423 <- readRDS('GSE222524_RAW/GSM6925423_A_seurat.rds')
GSM6925424 <- readRDS('GSE222524_RAW/GSM6925424_B_seurat.rds')
